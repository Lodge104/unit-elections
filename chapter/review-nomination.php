...
<head>
    ...
    <title>Review Nomination | Unit Elections Administration | Occoneechee Lodge - Order of the Arrow, BSA</title>
...
<body id="dashboard">
  ...
  <div class="wrapper">
    ...
    <main class="container-fluid col-xl-11">
      ...
      <div class="card mb-3">
        <div class="card-body">
          <h1 class="card-title">Review Adult Nomination</h1>
            ...
            <form action="../export-adult/approve-nomination-process.php" method="post">
			<div class="col-md-12">
		  ...
		  <div class="form-row justify-content-center">
                <div class="col-md-5">
                  <div class="form-group">
                    <label for="advisor_signature" class="required">Approve or Disapprove</label>
                        <select id="advisor_signature" name="advisor_signature" class="custom-select" disabled>
							<option></option>
              ...
              <a href="../chapter/adults.php" class="btn btn-primary" role="button">Return to All Adult Nominations</a></td>
            </form>
        </div>
	</div>
  <?php
