<?php
$title = "Election Results | Unit Leader Election Portal | Occoneechee Lodge - Order of the Arrow, BSA";
    ...
    <main class="container-fluid">
      <div class="card mb-3">
        <div class="card-body">
          ...
          if ($accessKey == "all") {
            ?><h3 class="card-title">Elected Scouts</h3><div class="mt-4 alert alert-danger" role="alert">
                Please select a unit to view.
              </div><?php
