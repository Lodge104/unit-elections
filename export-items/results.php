<?php
$title = "Election Results | Leadership Election Portal | Occoneechee Lodge - Order of the Arrow, BSA";
        ...
        <div class="card-body">
          ...
          if ($accessKey == "all") {
            ...
            if (array_key_exists($accessKey, $unitArr)) {
              ?><a href="export.php?accessKey=<?php echo $accessKey; ?>" target="_blank" class="btn btn-primary float-right mb-2">Export</a><h3 class="card-title">Elected Scouts from <?php echo $unitArr[$accessKey]['unitCommunity'] . " ". $unitArr[$accessKey]['unitNumber']; ?></h3><?php
