...
if (isset($_POST['exported'])) {  $exported = $_POST['exported']; } else { $exported = ""; }
...
$updateElection1 = $conn->prepare("UPDATE unitElections SET exported=? WHERE id = ?");
$updateElection1->bind_param("ss", $exported, $unitId);
